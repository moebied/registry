...
def pastpatients():
    ...
    for entry in patients:
        patient = patients[count]["patientid"]
        firstname = patients[count]["firstname"]
        lastname = patients[count]["lastname"]
        age = patients[count]["age"]
        sex = patients[count]["sex"]
        bodypart = patients[count]["bodypart"]
        implanttype = patients[count]["implanttype"]
        bodyside = patients[count]["bodyside"]
        prodceduretype=patients[count]["proceduretype"]
        date = patients[count]["date"]
        count += 1
